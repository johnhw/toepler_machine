...
module leyden_electrode(base, terminal_h, rod_thick, spark_ball)
{
    translate([0,0,0])       
    color("SlateGray")          
    difference()
...
module leyden(leyden_h, leyden_rad, leyden_chamfer, leyden_conduct_h, wall_thick, base, terminal_h, rod_thick, rod_connector_rad, jar=1, cap=1, electrode=1)
{
    ...
    {
       translate([0,0,leyden_h])
       leyden_electrode(base, terminal_h, rod_thick, rod_connector_rad);
    }
...
tol = 0.2;
leyden(200, 40, 10, 100, 1, 50, 100, 5, 16, 1, 1, 1);
*/